    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-bg px-6 py-16">
      <div className="max-w-xl w-full text-center">
        ...
        <h1 className="text-3xl sm:text-4xl font-bold mb-4">
          Prioritise Your <span className="text-accent">AI Use Cases</span> the Right Way
        </h1>
        ...
        <p className="text-muted/50 text-xs mt-4">Takes 1 minute to fill in · No signup required upfront</p>
      </div>
    </div>
  )
}
