    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-bg px-6 py-16">
      <div className="max-w-xl w-full text-center">
        ...
        <h1 className="text-3xl sm:text-4xl font-bold mb-4">
          Generate an <span className="text-accent">Enterprise AI PRD</span> in seconds
        </h1>
        ...
        <p className="text-muted/50 text-xs mt-4">Takes about 2 minutes to fill in · No signup required upfront</p>
      </div>
    </div>
  )
}
