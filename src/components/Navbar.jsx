  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-surface border-b border-border shadow-sm">
      <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
        <a href="/" className="text-navy font-bold text-lg tracking-tight">Rahul Kendale</a>
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <a
            ...
            className="bg-navy-light hover:bg-navy/20 text-navy border border-navy/20 text-sm font-semibold px-5 py-2.5 rounded-lg transition-colors"
          >
            Hire Me
          </a>
        </div>
      ...
      {open && (
        <div className="md:hidden border-t border-border bg-surface px-6 py-4 flex flex-col gap-4">
          ...
          <a href="/#work" className="text-muted text-sm font-medium" onClick={() => setOpen(false)}>Work</a>
          ...
          <Link to="/process" className="text-muted text-sm font-medium" onClick={() => setOpen(false)}>Process</Link>
          <a
            href="https://calendly.com/kendale-rahul/30min"
            target="_blank"
            rel="noopener noreferrer"
            className="bg-navy-light hover:bg-navy/20 text-navy border border-navy/20 text-sm font-semibold px-5 py-2.5 rounded-lg text-center"
          >
            Hire Me
          </a>
        </div>
