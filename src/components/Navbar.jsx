      ...
      <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <a
            ...
            className="bg-blue-300 hover:bg-blue-400 text-navy-dark text-sm font-semibold px-5 py-2.5 rounded-lg transition-colors"
          >
            Hire Me
          </a>
        </div>
      ...
      {open && (
        <div className="md:hidden border-t border-border bg-surface px-6 py-4 flex flex-col gap-4">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="bg-blue-300 text-navy-dark text-sm font-semibold px-5 py-2.5 rounded-lg text-center"
          >
            Hire Me
          </a>
        </div>
